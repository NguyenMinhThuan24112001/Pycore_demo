"""list- danh sách"""
"""cách tạo ra một list"""
# my_list = [1, 2, 3, 4, 5, -2] #list số nguyên
# your_list = [1, 2, 3, -0.1, 2.224]#list số nguyên và thực
# a = [1,2,3, [0, 1], my_list, your_list]#list hỗn hợp gồn nhiều kiểu dữ liệu
"""truy cập vào list"""
"""bằng chỉ số dương
bằng chỉ số âm
bằng đoạn cắt
"""
# s = ["first", 1, 2, 3, 'l ', [4, 5, 6, 7]]
# print(len(s))
# print(s[0])
# print(s[5])
# print(s[3])
# # trường hợp có list lồng nhau
# print(s[-2])
# print(s[-1][-1])
# print(s[5][2])
# print(s[2:5])
...
# my_list[1:4] = [-1, -2, -3]
# print(my_list)
#Thêm một phần tử vào list ban đầu dùng append() hoặc thêm list vào list thì dùng extend()
#chỉ thêm vào cuối list
# s = [0,1,2]
# s.append(3)
# print(s)
# s.extend([-3, -2, -1])
# print(s)
#phép cộng và phép nhân list với 1 số nguyên n
# s1 = [0, 1]
# print(s1 + [2,3,4,5,6,7])
# print(s1 * 3)
"""chèn thêm 1 phần tử vào list"""
# my = [0, 2, 6, 7]
# #my.insert(2, 4)
# print(my)
# my[3:3] = [5, -5, -6, -7]

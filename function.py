...
# func_greet('Ame', 'Hi',
          # 'I am Yuki!')  # TH3: Thừa tham số: TypeError: func_greet() takes 2 positional arguments but 3 were given
...
""" Python cung cấp các cách khác nhau kể khai báo tham số cho function """
""" - TH1: Tham số với giá trị mặc định.

...
# year = 2021
# print(year)
# print("Năm nay, python đã", year-1980)
# a, b, c = 4, 7, 8
# trung_binh_cong = (a + b + c) / 3
# print(trung_binh_cong)
# val1 = 2 + 3j
# print(type(val1))
# em_nguoi_yeu = """ Người yêu của tôi tên là Ngọc Ánh
#              cô ấy rất xinh gái và tốt tính"""
# print(em_nguoi_yeu)
# s1 = 'Nguyễn'
# s2 = "Thị"
# s3 = "Ngọc"
...
# first, last = 'py', 'thon'
# print("xin chao %s, toi la %s" % (first, last))
# """cách 2"""
x, y = 123, 456
# print("gia tri cua x la {}, cua y la {}, trung binh cong la {}".format(x, y, (x+y)/2))
print("gia tri cua x la {1}, cua y la {0}, trung binh cong la {2}".format(x, y, (x+y)/2))
"""nhập dữ liệu với hàm input()
+gặp lệnh này, chương trình sẽ chờ người dùng nhập vào gì đó và bấm phím enter
+dùng biến để lưu giá trị nhập này
+luôn nhận các giá trị nhập là kiểu dữ liệu str. nếu cần thì ép sang kiểu mong muốn
"""
# number = input("nhap vao :")
# print(number)
# print(type(number))
# number2 = int(input("nhap vao:"))
# print(number2)
# print(type(number2))
# coding=utf-8
